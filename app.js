...
const c_master_supplier = require('./controller/c_master_supplier')
...
app.get('/master-supplier', cek_login, c_master_supplier.index)
app.get('/master-supplier/tambah', cek_login, c_master_supplier.form_tambah)
app.post('/master-supplier/proses-simpan', cek_login, c_master_supplier.proses_simpan)
